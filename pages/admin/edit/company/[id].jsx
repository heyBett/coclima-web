...
export default function Example() {
  ...
  const url = "/api/admin/company?id=" + id;
  const { data: company } = useSWR(url, fetcher);
                  ...
                  <div className="grid grid-cols-4 gap-4 ">
                    ...
                    <div className="col-span-4 sm:col-span-2 xl:col-span-1">
                      ...
                      <div className="flex mt-1 rounded-md shadow-sm">
                        <input
                          required
                          {...register("cpfcnpj", { value: company.cpfcnpj })}
                          type="text"
                          name="cpfcnpj"
                          id="cpfcnpj"
                          className="flex-grow block w-full min-w-0 border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div className="col-span-4 sm:col-span-2 xl:col-span-1">
                      ...
                      <div className="flex mt-1 rounded-md shadow-sm">
                        <input
                          required
                          {...register("email", { value: company.email })}
                          type="email"
                          name="email"
                          id="email"
                          autoComplete="email"
                    ...
                    <div className="col-span-4 sm:col-span-2 xl:col-span-1">
                      ...
                      <div className="flex mt-1 rounded-md shadow-sm">
                        <input
                          required
                          {...register("phone", { value: company.phone })}
                          type="text"
                          name="phone"
                          id="phone"
                          className="flex-grow block w-full min-w-0 border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div className="col-span-2 sm:col-span-1">
                      ...
                      <div className="flex mt-1 rounded-md shadow-sm">
                        <select
                          {...register("role", { value: company.role })}
                          name="role"
                          id="role"
                          autoComplete="role"
                          className="flex-grow block w-full min-w-0 border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-1">
                      ...
                      <input
                        type="text"
                        {...register("site", { value: company.site })}
                        name="site"
                        id="site"
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-1">
                      ...
                      <input
                        type="text"
                        {...register("cep", { value: company.cep })}
                        name="cep"
                        id="cep"
                        autoComplete="cep"
                        className="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div className="col-span-4 sm:col-span-2">
                      ...
                      <select
                        id="state"
                        {...register("state", { value: company.state })}
                        name="state"
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-1">
                      ...
                      <input
                        type="text"
                        {...register("city", { value: company.city })}
                        name="city"
                        id="city"
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-1">
                      ...
                      <input
                        type="text"
                        {...register("district", { value: company.district })}
                        name="district"
                        id="district"
                        className="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                      />
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-2">
                      ...
                      <input
                        required
                        type="text"
                        {...register("street", { value: company.street })}
                        name="street"
                        autoComplete="street"
                        className="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                      />
                    ...
                    <div className="col-span-4 sm:col-span-2 lg:col-span-1">
                      ...
                      <input
                        type="text"
                        {...register("number", { value: company.number })}
                        name="number"
                        id="number"
                        className="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                      />
