      ...
      <div className="h-full flex">
          ...
          <div className="flex flex-col w-20">
            <div className="flex-1 flex flex-col min-h-0 overflow-y-auto bg-green-600">
              <div className="flex-1">
                <div className="bg-green-700 py-4 flex items-center justify-center">
                  <img
                    className="h-8 w-auto"
        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
          ...
          <div className="lg:hidden">
            <div className="bg-green-600 py-2 px-4 flex items-center justify-between sm:px-6 lg:px-8">
              <div>
                <img
                  className="h-8 w-auto"
                  src="https://tailwindui.com/img/logos/workflow-mark.svg?color=white"
