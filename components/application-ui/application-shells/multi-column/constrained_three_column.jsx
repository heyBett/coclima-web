  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex flex-col">
        {/* Navbar */}
        <Disclosure as="nav" className="flex-shrink-0 bg-green-600">
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="lg:hidden">
                <div className="px-2 pt-2 pb-3">
                  ...
                  <Disclosure.Button
                    as="a"
                    href="#"
                    className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-green-200 hover:text-green-100 hover:bg-green-600"
                  >
                    Support
                  </Disclosure.Button>
                </div>
