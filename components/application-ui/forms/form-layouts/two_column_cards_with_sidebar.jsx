          ...
          {navigation.map((item) => (
            <a
              ...
              className={classNames(
                item.current
                  ? "bg-gray-50 text-green-700 hover:text-green-700 hover:bg-white"
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="col-span-3 sm:col-span-2">
                  ...
                  <div className="mt-1 rounded-md shadow-sm flex">
                    ...
                    <input
                      ...
                      className="focus:ring-green-500 focus:border-green-500 flex-grow block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300"
                    />
                  </div>
                </div>
                ...
                <div className="col-span-3">
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <button
                      type="button"
                      className="ml-5 bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
                      Change
                    </button>
                  </div>
