                    ...
                    {activeOption && (
                      <div className="hidden h-96 w-1/2 flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex">
                        ...
                        <div className="flex flex-auto flex-col justify-between p-6">
                          ...
                          <button
                            type="button"
                            className="mt-6 w-full rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                          >
                            Send message
                          </button>
                        </div>
