        ...
        <form className="mt-6 sm:flex sm:items-center" action="#">
          ...
          <div className="relative rounded-md shadow-sm sm:min-w-0 sm:flex-1">
            <input
              ...
              name="emails"
              id="emails"
              className="focus:ring-green-500 focus:border-green-500 block w-full pr-32 sm:text-sm border-gray-300 rounded-md"
            ...
            <div className="absolute inset-y-0 right-0 flex items-center">
              ...
              <select
                id="role"
                name="role"
                className="focus:ring-green-500 focus:border-green-500 h-full py-0 pl-4 pr-7 border-transparent bg-transparent text-gray-500 sm:text-sm rounded-md"
              >
        ...
        <ul role="list" className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {people.map((person, personIdx) => (
            <li key={personIdx}>
              <button
                type="button"
                className="group p-2 w-full flex items-center justify-between rounded-full border border-gray-300 shadow-sm space-x-3 text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
