                        ...
                        <div className="ml-4 flex-auto grid gap-y-3 gap-x-5 grid-rows-1 grid-cols-1 items-start sm:ml-6 sm:flex sm:gap-0 sm:items-center">
                          ...
                          <div className="flex items-center sm:flex-none sm:block sm:text-center">
                            ...
                            <select
                              ...
                              className="block max-w-full rounded-md border border-gray-300 py-1.5 text-base leading-5 font-medium text-gray-700 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 sm:text-sm"
                            >
                            ...
                            <button
                              type="button"
                              className="ml-4 font-medium text-green-600 hover:text-green-500 sm:ml-0 sm:mt-2"
                            >
                              <span>Remove</span>
                            </button>
                          </div>
