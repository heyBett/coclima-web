                ...
                <Disclosure.Panel>
                  ...
                  <form className="mt-10">
                    ...
                    <div className="flex space-x-4 mt-1">
                      ...
                      <button
                        type="submit"
                        className="bg-gray-200 text-sm font-medium text-gray-600 rounded-md px-4 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-green-500"
                      >
                        Apply
                      </button>
                    </div>
        ...
        >
          ...
          <div className="max-w-lg mx-auto lg:pt-16">
            ...
            <form className="mt-6">
              ...
              <button
                type="submit"
                className="w-full mt-6 bg-green-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
                Pay {total}
              </button>
