            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
                ...
                <div className="max-w-sm mx-auto">
                  ...
                  <form className="mt-4 sm:mt-6 sm:flex">
                    ...
                    <div className="mt-3 sm:flex-shrink-0 sm:mt-0 sm:ml-4">
                      <button
                        type="submit"
                        className="w-full bg-green-600 border border-transparent rounded-md shadow-sm py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-green-500"
                      >
                        Sign up
                      </button>
                    </div>
              ...
              <div className="mt-6 relative py-12 px-6 flex items-center sm:py-16 sm:px-10 lg:mt-0">
                <div className="absolute inset-0 rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-green-600 bg-opacity-90" />
                </div>
