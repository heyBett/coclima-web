...
export default function Example() {
  return (
    <div className="bg-white">
      ...
      />
      <div
        className="hidden lg:block fixed top-0 right-0 w-1/2 h-full bg-green-900"
        aria-hidden="true"
      />

      <header className="relative max-w-7xl mx-auto bg-green-900 py-6 lg:bg-transparent lg:grid lg:grid-cols-2 lg:gap-x-16 lg:px-8 lg:pt-16 lg:pb-10">
      ...
      <main className="relative grid grid-cols-1 gap-x-16 max-w-7xl mx-auto lg:px-8 lg:grid-cols-2">
        ...
        <section
          ...
          className="bg-green-900 text-green-300 pt-6 pb-12 md:px-10 lg:max-w-lg lg:w-full lg:mx-auto lg:px-0 lg:pt-0 lg:pb-24 lg:bg-transparent lg:row-start-1 lg:col-start-2"
        >
          ...
          <form>
            <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
              ...
              <div className="mt-10 flex justify-end pt-6 border-t border-gray-200">
                <button
                  type="submit"
                  className="bg-green-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-green-500"
                >
                  Pay now
                </button>
              </div>
