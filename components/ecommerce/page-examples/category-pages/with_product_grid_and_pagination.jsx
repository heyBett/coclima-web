      ...
      <main className="pb-24">
        ...
        >
          <div className="min-w-0 flex-1">
            <a
              href="#"
              className="inline-flex items-center px-4 h-10 border border-gray-300 rounded-md bg-white hover:bg-gray-100 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-offset-1 focus:ring-offset-green-600 focus:ring-green-600 focus:ring-opacity-25"
            >
              Previous
            </a>
          </div>
          <div className="hidden space-x-2 sm:flex">
            ...
            <a
              href="#"
              className="inline-flex items-center px-4 h-10 border border-green-600 ring-1 ring-green-600 rounded-md bg-white hover:bg-gray-100 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-offset-1 focus:ring-offset-green-600 focus:ring-green-600 focus:ring-opacity-25"
            >
              3
            </a>
