      ...
      <main className="mx-auto pt-14 pb-24 px-4 sm:pt-16 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
              ...
              <button
                type="button"
                className="w-full bg-green-50 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-green-700 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-green-500"
              >
                Preview
              </button>
            </div>
        ...
        <div className="max-w-2xl mx-auto mt-24 sm:mt-32 lg:max-w-none">
          <div className="flex items-center justify-between space-x-4">
            ...
            <a
              href="#"
              className="whitespace-nowrap text-sm font-medium text-green-600 hover:text-green-500"
            >
            ...
            <div className="mt-12 md:mt-0 md:row-start-2 md:col-start-3 md:col-span-8 lg:row-start-1 lg:col-start-9 lg:col-span-4">
              ...
              <form className="mt-3 sm:flex lg:block xl:flex">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 sm:flex-1 sm:min-w-0 sm:max-w-xs lg:max-w-none"
                />
