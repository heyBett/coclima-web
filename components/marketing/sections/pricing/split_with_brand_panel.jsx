  ...
  return (
    <div className="relative bg-white">
      <div className="absolute inset-0" aria-hidden="true">
        <div className="absolute inset-y-0 right-0 w-1/2 bg-green-700" />
      </div>
            ...
            <dl className="mt-12 space-y-10">
              {features.map((feature) => (
                <div key={feature.name} className="relative">
                  <dt>
                    <div className="absolute h-12 w-12 flex items-center justify-center bg-green-500 rounded-md">
                      <feature.icon
          ...
          <div className="max-w-lg mx-auto w-full space-y-8 lg:mx-0">
            <div>
              ...
              <p className="relative grid grid-cols-2">
                <span className="flex flex-col text-center">
                  ...
                  <span className="mt-2 text-base font-medium text-green-200">
                    Setup fee
                  </span>
            ...
            >
              {checklist.map((item) => (
                <li
                  key={item}
                  className="bg-green-800 bg-opacity-50 py-4 px-4 flex items-center space-x-3 text-base text-white"
                >
                  <CheckIcon
                    className="h-6 w-6 text-green-300"
                    aria-hidden="true"
            ...
            <a
              href="#"
              className="bg-white border border-transparent rounded-md w-full px-8 py-4 flex items-center justify-center text-lg leading-6 font-medium text-green-600 hover:bg-green-50 md:px-10"
            >
              Get started today
            </a>
            <a
              href="#"
              className="block text-center text-base font-medium text-green-200 hover:text-white"
            >
