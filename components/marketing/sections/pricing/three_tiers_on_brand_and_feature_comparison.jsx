    ...
    <div className="bg-gray-50">
      <div className="relative bg-green-600">
        ...
        <div className="relative mt-12 flex justify-center sm:mt-16">
          <div className="bg-green-700 p-0.5 rounded-lg flex">
            <button
              type="button"
              className="relative bg-white py-2 px-6 border-green-700 rounded-md shadow-sm text-sm font-medium text-green-700 whitespace-nowrap hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-white focus:z-10"
            >
              Monthly billing
            </button>
            <button
              type="button"
              className="ml-0.5 relative py-2 px-6 border border-transparent rounded-md text-sm font-medium text-green-200 whitespace-nowrap hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-white focus:z-10"
            >
              Yearly billing
            </button>
          </div>
            ...
            {plans.map((plan) => (
              <div
                ...
                className={classNames(
                  plan.featured
                    ? "bg-white ring-2 ring-green-700 shadow-md"
                    : "bg-green-700 lg:bg-transparent",
                  ...
                  <div className="flex flex-col items-start sm:flex-row sm:items-center sm:justify-between lg:flex-col lg:items-start">
                    <div className="mt-3 flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p
                          className={classNames(
                            plan.featured ? "text-gray-500" : "text-green-200",
                            "text-sm"
                          )}
                        >
          ...
          {plans.map((plan, mobilePlanIndex) => (
            <div key="plan.title" className="border-t border-gray-200">
              ...
              >
                <h3
                  className={classNames(
                    plan.featured ? "text-green-600" : "text-gray-900",
                    "text-sm font-bold"
                  )}
                >
                  {plan.title}
