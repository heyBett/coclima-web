          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center border-b border-green-400 border-opacity-25 py-6 md:justify-start md:space-x-10">
              ...
              <div className="-mr-2 -my-2 md:hidden">
                <Popover.Button className="bg-green-900 rounded-md p-2 inline-flex items-center justify-center text-green-300 hover:text-white hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <Popover.Group as="nav" className="hidden md:flex space-x-10">
                    ...
                    <>
                      <Popover.Button
                        className={classNames(
                          open ? "text-white" : "text-green-300",
                          "group bg-green-900 rounded-md inline-flex items-center text-base font-medium hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-900 focus:ring-white"
                        )}
                      >
                        <span>Solutions</span>
                        <ChevronDownIcon
                ...
                <a
                  href="#"
                  className="text-base font-medium text-green-300 hover:text-white"
                >
                  Pricing
                </a>
                <a
              ...
              <div className="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
                <a
                  href="#"
                  className="whitespace-nowrap text-base font-medium text-green-300 hover:text-white"
                >
                  Sign in
                </a>
                <a
                  href="#"
                  className="whitespace-nowrap bg-white border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex items-center justify-center text-base font-medium text-green-600 hover:bg-green-50"
                >
                  Sign up
                </a>
              </div>
        ...
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="px-0 sm:px-4 lg:px-0 lg:flex lg:justify-between lg:items-center">
            ...
            <div className="mt-10 w-full max-w-xs lg:mt-0">
              <label
                htmlFor="currency"
                className="block text-base font-medium text-green-300"
              >
                Currency
              </label>
              <div className="mt-1.5 relative">
                <select
                  id="currency"
                  name="currency"
                  className="block w-full bg-none bg-green-400 bg-opacity-25 border border-transparent text-white focus:ring-white focus:border-white rounded-md"
